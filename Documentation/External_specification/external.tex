...
\begin{figure}[H]
    \centering
    \subfloat[Czarne tło.]{\includegraphics[width=7.3cm]{../images/example_program.png}\label{fig:f1}}
    \hfill
    \subfloat[Obraz z kamery.]{\includegraphics[width=7.3cm]{../images/cam_example.png}\label{fig:f2}}
