...
\begin{figure}[H]
    \centering
    \subfloat[Obraz z kamery.]{\includegraphics[width=7.3cm]{example-image-a}\label{fig:f1}}
    \hfill
    \subfloat[Czarne tło.]{\includegraphics[width=7.3cm]{example-image-a}\label{fig:f2}}
